...
class KotlinAppApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes kotlin_app.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KotlinAppApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KotlinAppApp::class.java)
